...
# App Layout
# =========================
st.set_page_config(page_title="Temperatura da Pauta — Pro v3", page_icon="🔥", layout="wide")
st.title("🔥 Temperatura da Pauta — Pro v3")
...
CONFIG = {
    ...
    "pesos_iniciais": DEFAULT_CONFIG["pesos_iniciais"],
...
if trends_file is not None:
    try:
        ...
        st.write("Prévia dos dados:", df_trends.head())

        # Gray line chart with labels
        try:
...
st.markdown("---")
st.caption("Creative Data • Temperatura da Pauta — Pro v3 (com gráfico cinza do Google Trends)")
