...
# App
# =========================
st.set_page_config(page_title="Temperatura da Pauta — Pro v4", page_icon="🔥", layout="wide")
st.title("🔥 Temperatura da Pauta — Pro v4")
...
st.markdown("---")
st.caption("Creative Data • Temperatura da Pauta — Pro v4 (pesos no sidebar + donuts)")
